...
export default function ({ navigation }) {
    ...
    return (
        <LinearGradient
            ...
            {wordModalVisible && <ErrorModal reverse={modalReverse} buttonText={"Fermer"} visible={wordModalVisible} handleCloseModal={() => setWordModalVisible(false)} >Vous avez trouvé le bon mot ! Voici le prochain mot à faire deviner à votre équipe :{"\n"}{"\n"}{nextWordToDisplay}</ErrorModal>}
        </LinearGradient>
    )
}